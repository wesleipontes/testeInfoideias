                ...
                <div class="col-md-12">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-collapse2">
                        <ul class="nav navbar-nav navbar-right">
                            <li class="active">
                                <a href="<?php echo $this->url->get(array('for' => 'noticia.lista')); ?>">
								...
								<table id="lista-noticia" class="table dataTable table-hover">
									...
									<tbody>
										<tr>
                                            ...
                                            <td>
                                                <a href="<?php echo $this->url->get(array('for' => 'noticia.editar', 'id' => 1)); ?>"><span class="glyphicon glyphicon-pencil"></span></a>
                                                <a href="<?php echo $this->url->get(array('for' => 'noticia.excluir', 'id' => 1)); ?>"><span class="glyphicon glyphicon-remove-sign"></span></a>
                                            </td>
										</tr>
                                        <tr>
                                            <td><a href="#">#2</a></td>
                                            ...
                                            <td>
                                                <a href="<?php echo $this->url->get(array('for' => 'noticia.editar', 'id' => 2)); ?>"><span class="glyphicon glyphicon-pencil"></span></a>
                                                <a href="<?php echo $this->url->get(array('for' => 'noticia.excluir', 'id' => 2)); ?>"><span class="glyphicon glyphicon-remove-sign"></span></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><a href="#">#3</a></td>
                                            ...
                                            <td>
                                                <a href="<?php echo $this->url->get(array('for' => 'noticia.editar', 'id' => 3)); ?>"><span class="glyphicon glyphicon-pencil"></span></a>
                                                <a href="<?php echo $this->url->get(array('for' => 'noticia.excluir', 'id' => 3)); ?>"><span class="glyphicon glyphicon-remove-sign"></span></a>
                                            </td>
                                        </tr>
									</tbody>
								</table>
