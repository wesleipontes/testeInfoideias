            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <?php echo $this->tag->form(array('noticias/salvar', 'method' => 'post', 'enctype' => 'multipart/form-data', 'name' => 'cadastrar')); ?>
                        <?php echo $this->tag->hiddenField(array('id', 'value' => $noticia->getId())); ?>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="form-group col-sm-12">
                                                <p><strong>Data de Criação:</strong> <?php echo $noticia->getDataCadastro(); ?></p>
                                                <p><strong>Data da Última Atualização:</strong> <?php echo $noticia->getDataUltimaAtualizacao(); ?></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-sm-12">
                                                <label for ="Titulo">Título <span class="error">(*)<span></label>
                                                <?php echo $this->tag->textField(array('titulo', 'value' => $noticia->getTitulo(), 'width' => '100%', 'class' => 'form-control')); ?>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-sm-12">
                                                <label for ="Texto">Texto</label>
                                                <?php echo $this->tag->textArea(array('texto', 'value' => $noticia->getTexto(), 'class' => 'form-control')); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
