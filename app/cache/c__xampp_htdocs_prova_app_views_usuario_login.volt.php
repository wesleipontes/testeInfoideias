...
<html lang="pt-BR">
    <head>
        ...
        <meta charset="utf-8">
        <title>Sistema de Chamados :: Infoidéias</title>
...
<body class="login-img3-body">
    ...
    <div class="container">
        ...
        <?php echo $this->tag->form(array('', 'method' => 'post', 'class' => 'login-form')); ?>
            <div class="login-wrap">
                ...
                <div class="input-group">
                    ...
                    <?php echo $this->tag->emailField(array('email', 'class' => 'form-control', 'placeholder' => 'E-mail', 'autofocus', 'required' => 'required', 'value' => $this->session->get('email'))); ?>
                    <?php echo $this->session->remove('email'); ?>
                </div>
                <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                    <?php echo $this->tag->passwordField(array('password', 'class' => 'form-control', 'placeholder' => 'Senha', 'required' => 'required', 'value' => '')); ?>
                </div>
                <div class="group-remember-me-forgot-my-password">
                    <label style="font-weight: 100">
                        <?php echo $this->tag->checkField(array('remember_me', 'value' => 'S')); ?> <span>Continuar Conectado</span>
                    </label>
                ...
                <div id="div-btn-login" class="form-group" style="margin-top:15px">
                    <button class="btn btn-primary btn-lg btn-block" type="submit" formaction="<?php echo $this->url->get(array('for' => 'login')); ?>">Entrar</button>
                </div>

                <div id='div-btn-forgot-my-password' class="form-group hidden">
                    <button class="btn btn-primary btn-lg btn-block" type="submit" formaction="<?php echo $this->url->get(array('for' => 'usuario.esqueci-minha-senha')); ?>">Enviar Senha por Email</button>
